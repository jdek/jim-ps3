#!/bin/sh
# gcc-4.5.0-SPU-stage1.sh by Dan Peori (dan.peori@oopo.net)
...
## Configure the build.
../configure --prefix="$PS3DEV/spu" --target="spu" --enable-languages="c" --without-headers --disable-libssp || { exit 1; }
