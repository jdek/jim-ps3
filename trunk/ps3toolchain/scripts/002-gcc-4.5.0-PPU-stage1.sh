#!/bin/sh
# gcc-4.5.0-PPU-stage1.sh by Dan Peori (dan.peori@oopo.net)
...
## Configure the build.
../configure --prefix="$PS3DEV/ppu" --target="ppu" --enable-languages="c" --without-headers --disable-libssp || { exit 1; }
